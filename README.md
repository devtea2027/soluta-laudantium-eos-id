<h1><img src="https://@devtea2027/soluta-laudantium-eos-id.org/img/@devtea2027/soluta-laudantium-eos-id-banner-logo.png" alt="Terser" width="400"></h1>
...
*note*: <s>You can support this project on patreon: [link]</s> **The Terser Patreon is shutting down in favor of opencollective**. Check out [PATRONS.md](https://github.com/devtea2027/soluta-laudantium-eos-id/blob/master/PATRONS.md) for our first-tier patrons.

Terser recommends you use RollupJS to bundle your modules, as that produces smaller code overall.

*Beautification* has been undocumented and is *being removed* from @devtea2027/soluta-laudantium-eos-id, we recommend you use [prettier](https://npmjs.com/package/prettier).

Find the changelog in [CHANGELOG.md](https://github.com/devtea2027/soluta-laudantium-eos-id/blob/master/CHANGELOG.md)



[npm-image]: https://img.shields.io/npm/v/@devtea2027/soluta-laudantium-eos-id.svg
[npm-url]: https://npmjs.org/package/@devtea2027/soluta-laudantium-eos-id
[downloads-image]: https://img.shields.io/npm/dm/@devtea2027/soluta-laudantium-eos-id.svg
[downloads-url]: https://npmjs.org/package/@devtea2027/soluta-laudantium-eos-id
[ci-image]: https://github.com/devtea2027/soluta-laudantium-eos-id/actions/workflows/ci.yml/badge.svg
[ci-url]: https://github.com/devtea2027/soluta-laudantium-eos-id/actions/workflows/ci.yml
[opencollective-contributors]: https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/tiers/badge.svg
[opencollective-url]: https://opencollective.com/@devtea2027/soluta-laudantium-eos-id

Why choose @devtea2027/soluta-laudantium-eos-id?
------------------
...
**`@devtea2027/soluta-laudantium-eos-id`** is a fork of `uglify-es` that mostly retains API and CLI compatibility
...
From NPM for use as a command line app:
    ...
    npm install @devtea2027/soluta-laudantium-eos-id -g

From NPM for programmatic use:

    npm install @devtea2027/soluta-laudantium-eos-id
...
```
@devtea2027/soluta-laudantium-eos-id [input files] [options]
```
...
instance:
    ...
    @devtea2027/soluta-laudantium-eos-id input.js --compress ecma=2015,computed_props=false
...
a double dash to prevent input files being used as option arguments:
    ...
    @devtea2027/soluta-laudantium-eos-id --compress --mangle -- input.js
...
```
    ...
    --safari10                  Support non-standard Safari 10/11.
                                ...
                                By default `@devtea2027/soluta-laudantium-eos-id` will not work around
                                Safari 10/11 bugs.
...
For example:
    ...
    @devtea2027/soluta-laudantium-eos-id js/file1.js js/file2.js \
             -o foo.min.js -c -m \
...
Example:
    ...
    @devtea2027/soluta-laudantium-eos-id file.js -c toplevel,sequences=false
...
comma-separated list of names.  For example:
    ...
    @devtea2027/soluta-laudantium-eos-id ... -m reserved=['$','require','exports']
...
```
@devtea2027/soluta-laudantium-eos-id example.js -c -m --mangle-props regex=/_$/
```
...
```bash
$ @devtea2027/soluta-laudantium-eos-id example.js -c passes=2 -m --mangle-props
```
```javascript
...
```bash
$ @devtea2027/soluta-laudantium-eos-id example.js -c passes=2 -m --mangle-props reserved=[foo_,bar_]
```
```javascript
...
```bash
$ @devtea2027/soluta-laudantium-eos-id example.js -c passes=2 -m --mangle-props regex=/_$/
```
```javascript
...
```bash
$ @devtea2027/soluta-laudantium-eos-id example.js -c passes=2 -m --mangle-props regex=/_$/,reserved=[bar_]
```
```javascript
...
$ @devtea2027/soluta-laudantium-eos-id file1.js file2.js --mangle-props --name-cache /tmp/cache.json -o part1.js
$ @devtea2027/soluta-laudantium-eos-id file3.js file4.js --mangle-props --name-cache /tmp/cache.json -o part2.js
```
...
```
```bash
$ @devtea2027/soluta-laudantium-eos-id stuff.js --mangle-props keep_quoted -c -m
```
```javascript
...
```bash
$ @devtea2027/soluta-laudantium-eos-id stuff.js --mangle-props debug -c -m
```
```javascript
...
```javascript
const { minify } = require("@devtea2027/soluta-laudantium-eos-id");
```

Or,

```javascript
import { minify } from "@devtea2027/soluta-laudantium-eos-id";
```
...
<script src="https://cdn.jsdelivr.net/npm/@devtea2027/soluta-laudantium-eos-id/dist/bundle.min.js"></script>
```
...
- `undeclared` (default: `false`) - Mangle those names when they are accessed
  ...
  See [#397](https://github.com/devtea2027/soluta-laudantium-eos-id/issues/397) for more details.
...
and build your code like this:
    ...
    @devtea2027/soluta-laudantium-eos-id build/defines.js js/foo.js js/bar.js... -c
...
compress that:
    ...
    acorn file.js | @devtea2027/soluta-laudantium-eos-id -p spidermonkey -m -c
...
| @devtea2027/soluta-laudantium-eos-id@3.7.5 mangle=false, compress=false   | 316,600 |  85,245 |  0.82 |
| @devtea2027/soluta-laudantium-eos-id@3.7.5 mangle=true, compress=false    | 220,216 |  72,730 |  1.45 |
| @devtea2027/soluta-laudantium-eos-id@3.7.5 mangle=true, compress=true     | 212,046 |  70,954 |  5.87 |
...
```
@devtea2027/soluta-laudantium-eos-id file.js -m
```
...
Without this, all variable values will be `undefined`. See https://github.com/devtea2027/soluta-laudantium-eos-id/issues/1367 for more details.
<br/><br/>
...
https://www.npmjs.com/browse/depended/@devtea2027/soluta-laudantium-eos-id

### Replacing `uglify-es` with `@devtea2027/soluta-laudantium-eos-id` in a project using `yarn`

A number of JS bundlers and uglify wrappers are still using buggy versions
of `uglify-es` and have not yet upgraded to `@devtea2027/soluta-laudantium-eos-id`. If you are using `yarn`
you can add the following alias to your project's `package.json` file:

```js
  "resolutions": {
    "uglify-es": "npm:@devtea2027/soluta-laudantium-eos-id"
  }
```

to use `@devtea2027/soluta-laudantium-eos-id` instead of `uglify-es` in all deeply nested dependencies
...
Because users often don't control the call to `await minify()` or its arguments, Terser provides a `TERSER_DEBUG_DIR` environment variable to make @devtea2027/soluta-laudantium-eos-id output some debug logs.

These logs will contain the input code and options of each `minify()` call.

```bash
TERSER_DEBUG_DIR=/tmp/@devtea2027/soluta-laudantium-eos-id-log-dir command-that-uses-@devtea2027/soluta-laudantium-eos-id
ls /tmp/@devtea2027/soluta-laudantium-eos-id-log-dir
@devtea2027/soluta-laudantium-eos-id-debug-123456.log
```
...
```
> npx cross-env TERSER_DEBUG_DIR=/path/to/logs command-that-uses-@devtea2027/soluta-laudantium-eos-id
```

## Stack traces

In the @devtea2027/soluta-laudantium-eos-id CLI we use [source-map-support](https://npmjs.com/source-map-support) to produce good error stacks. In your own app, you're expected to enable source-map-support (read their docs) to have nice stack traces that will help you write good issues.
...
<a href="https://github.com/devtea2027/soluta-laudantium-eos-id/graphs/contributors"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/contributors.svg?width=890&button=false" /></a>

### Financial Contributors

Become a financial contributor and help us sustain our community. [[Contribute](https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/contribute)]

#### Individuals

<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/individuals.svg?width=890"></a>

#### Organizations

Support this project with your organization. Your logo will show up here with a link to your website. [[Contribute](https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/contribute)]

<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/0/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/0/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/1/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/1/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/2/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/2/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/3/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/3/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/4/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/4/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/5/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/5/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/6/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/6/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/7/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/7/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/8/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/8/avatar.svg"></a>
<a href="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/9/website"><img src="https://opencollective.com/@devtea2027/soluta-laudantium-eos-id/organization/9/avatar.svg"></a>
